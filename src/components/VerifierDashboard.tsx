  ...
  useEffect(() => {
    const handleData = async () => {
      ...
      if (resData.pendingApplications !== undefined) {
        const result: LoanDetailsVerifier[] = resData.pendingApplications.map(
          (i) => ({
            id: i.id,
          ...
          <div className="grid grid-rows-[1fr_9fr] sm:h-auto">
            ...
            <div className="flex flex-col h-full w-full bg-[#0A512F]">
              <button
                ...
                className="flex items-center w-full text-white text-sm 2xl:text-xl font-bold h-14 pl-3 bg-[#0A512F] border-black cursor-pointer hover:h-16 hover:bg-green-800 transition-all duration-300 ease-in"
              >
              ...
              <button
                ...
                className="flex items-center w-full text-white text-sm 2xl:text-xl font-bold h-14 pl-3 border-t-2 border-b-2 bg-[#0A512F] border-black cursor-pointer hover:h-16 hover:bg-green-800 transition-all duration-300 ease-in"
              >
            ...
            <div className="grid grid-rows-2 grid-cols-3 gap-4 p-4">
              <div className="grid grid-cols-1 sm:grid-cols-[4fr_6fr] xl:grid-cols-[2.5fr_7.5fr] rounded-lg sm:rounded-none shadow-md">
                ...
                <div className="bg-white sm:w-full rounded-lg sm:rounded-none">
                  <p className="w-full h-2/5 pl-1 sm:pl-4 pt-2 font-bold text-sm xl:text-2xl">
                    50
                  </p>
                  <p className="w-full h-2/5 pl-1 sm:pl-4 font-semibold text-sm xl:text-2xl">
                    LOANS
                  </p>
                </div>
              </div>
