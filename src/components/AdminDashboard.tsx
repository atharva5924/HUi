          ...
          <div className="grid grid-rows-[1fr_9fr] sm:h-auto">
            ...
            <div className="flex flex-col h-full w-full bg-[#0A512F]">
              ...
              <button
                ...
                className="flex items-center w-full text-white text-sm 2xl:text-xl font-bold h-14 pl-3 border-t-2 bg-[#0A512F] border-black cursor-pointer hover:h-16 hover:bg-green-800 transition-all duration-300 ease-in"
              >
